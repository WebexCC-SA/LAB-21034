...
- **Initial questions** — Greet the caller and understand why they need Cisco Event Health.
...
You are designing the **Concierge AI Agent** for **Cisco Event Health**. This is the first agent the caller reaches.
